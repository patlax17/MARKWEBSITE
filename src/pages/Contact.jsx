...
export default function Contact() {
  return (
    <>
      <TopHeader />
      <main className="pt-28 md:pt-24 px-8 md:px-16 pb-20 max-w-xl">
        ...
        <div className="flex flex-col gap-4 text-sm font-light text-black leading-loose opacity-80 mb-12">
          <p>Available for editorial, documentary, sports, and portrait commissions.</p>
          <p>Based in New York. Available to travel.</p>
        </div>

        <div className="flex flex-col gap-4">
          <a href="mailto:contact@markmilitar.com" className="nav-link">
